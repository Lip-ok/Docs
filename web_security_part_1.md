...
### 1: SQL-инъекции — классика, которая всё ещё ломает сайты
...
### 2: XSS — когда пользователь пишет JavaScript за тебя
...
### 3: Пароли — никогда не храни их как есть
...
### 4: JWT — не доверяй клиенту слепо
...
### 7: HTTPS — не опция, а обязательство
...
### 8: Environment variables — не храни секреты в коде
...
### 9: Проверка данных — доверяй, но проверяй
...
### 10: Ошибки — не раскрывай лишнего
